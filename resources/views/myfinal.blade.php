            ...
            <div class="sport-row align-items-center">
                <div class="row">
                    <div class="col-md-4">
                        <div class="sport-table-title">
                            ...
                            <div class="sport-table-title-item sport-table-title-item-right">
                                <span
                                    class="sport-table-title-score"><span><?php echo $scoredatas["home_rot"]; ?></span></span>
                                <span
                                    class="sport-table-title-score"><span><?php echo $scoredatas["away_rot"]; ?></span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3">
                        <div class="sport-table-title-item sport-table-title-item-right">
                            <span
                                class="sport-table-title-score"><span>HOME SCORE: <?php echo $periods["home_score"]; ?></span></span>
                            <span
                                class="sport-table-title-score"><span>AWAY SCORE: <?php echo $periods["away_score"]; ?></span></span>
                        </div>
                    </div>
                </div>
            </div>
